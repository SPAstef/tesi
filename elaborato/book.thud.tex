...
%        \ifpdf\makebox[\z@][l]{\raisebox{-.98\textheight}[\z@][\z@]{\includegraphics[height=\textheight]{UdineLogo}}}\fi%
        \begin{minipage}[t][\textheight][s]{.99\linewidth}%
            ...
            {\Large\thud@universityA}%
            \ifx\thud@chair\@empty\else\par\medskip\chairname: \thud@chair\fi%
            \vfill%
            \begin{center}%
                {\fontfamily{lmr}\selectfont\Large\scshape \thesisname \ifx\thud@phdnumber\@empty\else\space\thud@phdnumber\fi\par}
                \vskip 4em\relax%
                \noindent\vrule height 2.5pt width \textwidth
                \vskip 1em\relax%
                {\fontfamily{ptm}\selectfont\Huge\bfseries\itshape\@title\par}
                \vskip 1em\relax%
                \noindent\vrule height 2.5pt width \textwidth
    ...
    {\parindent\z@\relax%
        ...
        \vspace*{64pt}
        \textsc{\institutecontactsname}\\\thud@universityC\par%
